...
const dictionaries: Record<Locale, Dict> = {
  en: {
    ...
    "achievements.desc": "Two-time Top Seller at Danube Properties, one of Dubai's most established developers — with over AED 15M in closed sales.",
  ...
  fa: {
    ...
    "achievements.desc": "دو دوره فروشنده برتر شرکت سازنده معتبر دانوب با بیش از ۱۵ میلیون درهم فروش.",
    ...
    "projects.title": "گزیده‌ای از بهترین آدرس‌های دبی.",
    ...
    "form.message": "پیام",
    "blog.eyebrow": "مجله",
    "blog.title": "یادداشت‌هایی از بازار دبی.",
  ...
  ku: {
    ...
    "achievements.title": "افتخارات کسب شده",
    "achievements.desc": "دوو جار فرۆشیاری سەرەکی کۆمپانیای ناودار دانوب بە زیاتر لە ١٥ ملیۆن درهم فرۆش.",
    ...
    "projects.title": "هەڵبژاردنێکی ناسک لە باشترین ناونیشانەکانی دوبەی.",
    ...
    "form.message": "پەیام",
    "blog.eyebrow": "گۆڤار",
    "blog.title": "تێبینی لە بازاڕی دوبەی.",
